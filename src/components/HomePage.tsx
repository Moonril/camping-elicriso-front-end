...
const HomePage = function (){
    ...
    return(
        ...
        <section className="min-h-screen bg-slate-50  text-white ">
            {/* hero */}
            <div id="hero" className="flex flex-col justify-center py-80 2xl:py-80 px-5 items-center gap-8 h-screen bg-[url('/hero-main.jpg')] bg-cover">
                            ...
                            <div className="flex flex-col sm:flex-row gap-8">
                                <div className="flex-1">
                                    <Link to={'/accommodations'}>
                                        <img src="small-tent.jpg" alt="" className="aspect-3/2 object-cover object-bottom rounded-2xl shadow-lg/30 transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
                                    </Link>
                                    <div className="p-5">
                                ...
                                <div className="flex-1">
                                    <Link to={'/accommodations'}>
                                        <img src="small-bung.jpg" alt="" className="aspect-3/2 object-cover object-bottom rounded-2xl shadow-lg/30 transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
                                    </Link>
                                    <div className="p-5">
                        ...
                        <div className="flex flex-col justify-between items-center gap-8 px-10 lg:px-20 pb-10">
                            ...
                            <div className="flex flex-col gap-8 items-center justify-center">
                                <div className="flex flex-col md:max-w-screen-lg sm:flex-row gap-8">
                                    <div className="flex-1">
                                        <img src="showers.jpg" alt="" className="aspect-3/2 object-cover object-[25%_70%] rounded-2xl shadow-lg/30" />
                                        <div className="p-5">
                                            <h5 className="mb-2 text-xl font-bold tracking-tight text-black text-center">Bagni e docce calde</h5>
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        <img src="sinks.jpg" alt="" className="aspect-3/2 object-cover object-bottom rounded-2xl shadow-lg/30" />
                                        <div className="p-5">
                                ...
                                <div className="flex flex-col md:max-w-screen-lg sm:flex-row gap-8">
                                    ...
                                    <div className="flex-1">
                                        <img src="barbecue.jpg" alt="" className="aspect-3/2 object-cover object-bottom rounded-2xl shadow-lg/30" />
                                        <div className="p-5">
                                            <h5 className="mb-2 text-xl font-bold tracking-tight text-black text-center">Barbecue</h5>
                                        </div>
                                    </div>
                                    <div className="flex-1">
                                        <img src="bonfire.jpg" alt="" className="aspect-3/2 object-cover object-bottom rounded-2xl shadow-lg/30" />
                                        <div className="p-5">
                            ...
                            <div className="flex flex-col sm:flex-row gap-8">
                                <div className="flex-1">
                                    <Link to={'/surroundings'}>
                                        <img src="sea.jpg" alt="seascape" className="aspect-3/2 object-cover object-bottom rounded-2xl shadow-lg/30 transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
                                    </Link>
                                        <div className="p-2">
                                ...
                                <div className="flex-1">
                                    <Link to={'/surroundings'}>
                                        <img src="hiking.jpg" alt="hiking scene" className="aspect-3/2 object-cover object-center rounded-2xl shadow-lg/30 transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
                                    </Link>
                                        <div className="p-2">
                                ...
                                <div className="flex-1">
                                    <Link to={'/surroundings'}>
                                        <img src="nightlife.jpg" alt="nightlife" className="aspect-3/2 object-cover object-center rounded-2xl shadow-lg/30 transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110" />
                                    </Link>
                                        <div className="p-2">
