    ...
    return(
        ...
        <section className="flex flex-col bg-white-300 dark:bg-green-950 py-50 items-center justify-content text-black dark:text-gray-200 p-6 gap-8">
            ...
            <div>
                ...
                <div className="grid md:grid-cols-2 md:gap-6 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    <select name="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" value={newBooking.accommodationType} onChange={(e) => {
                    ...
                    <select className="bg-gray-300 text-black" name="accommodation" id="accommodation">
                        <option className="bg-white" value="PLOT">Plot</option>
                        <option className="bg-white" value="MOBILEHOME">Mobile Home</option>
                        <option className="bg-white" value="GLAMPING">Glamping</option>
                    </select> 
