        ...
        <section className="bg-green-950 py-50">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-sm text-center">
                    ...
                    <p className="mb-4 text-3xl tracking-tight font-bold md:text-4xl text-white">Coming Soon.<PiMaskSad className="inline" /></p>
                    <p className="mb-4 text-lg font-light text-gray-400">Ci dispiace, la pagina che stai cercando ancora non esiste. </p>
