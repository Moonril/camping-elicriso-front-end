    ...
    return (
        ...
        <section className="bg-orange-50 bg-green-950 flex flex-col items-center justify-center px-6 py-20 lg:py-30 xl:py-20 mx-auto gap-8 text-black ">
            <div className="w-fullmd: p-10 rounded-2xl text-center">
                <img src="restaurant-banner.jpg" alt="dishes" className="rounded-2xl md:h-[200px] xl:h-[250px] w-full object-cover object-top my-5" />
                ...
                <img src="restaurant-banner.jpg" alt="dishes" className="hidden md:block rounded-2xl md:h-[200px] xl:h-[250px] w-full object-cover object-[25%_70%] my-5" />
            </div>
