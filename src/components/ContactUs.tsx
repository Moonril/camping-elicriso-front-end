        ...
        <section className="flex flex-col bg-orange-50 dark:bg-green-950 py-20 lg:py-30 xl:py-50 items-center justify-content text-black dark:text-gray-200 p-6 gap-8">
            ...
            <div className="flex flex-col w-full md:flex-row gap-8 items-center justify-center lg:p-10 px-10">
                ...
                <div className="flex flex-col w-full items-center justify-center">
                    ...
                    <div className="relative z-0 w-full mb-5 group">
                        <textarea name="floating_text" id="floating_text" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
                    ...
                    <div className="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            <input type="text" name="floating_bookingId" id="floating_bookingId" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " value={bookingId}/>
